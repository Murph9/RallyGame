...
public class CarDataConst implements Serializable {
	private static final String dir = "assets/models/";
	...
	public float rollFraction = 1; //TODO //fake to allow high cars to not roll as much
	
	public float areo_drag = 1;
	public float areo_lineardrag = 0;//TODO
	public float areo_crossSection = 0.47f; //m^2 front area
	public float areo_downforce = 0.0f; //no cars start with it
	
	public float sus_min_length = 0; //TODO so we can offset the start of the suspension up
	public float sus_max_length = 0.3f; //0.3f;
	public float sus_stiffness = 60f; //40;
	public float sus_max_force;
	
	private float sus_comp = 0.4f;
	private float sus_relax = 0.4f;
...
//	public float[] e_torque = new float[]{0,223,250,280,300,310,280,245,10};
	...
	public void refresh() {
		...
		//TODO should this be done outside of this method?
