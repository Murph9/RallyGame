...
public class CarUITelemetry extends BaseAppState {
    ...
    private void makeTelemetry(AssetManager am, Camera c) {
        ...
        b = new Box(5, 5, 1);
        gForceDot1 = new Geometry("g-circle1", b);
        gForceDot1.setLocalTranslation(gcenter);
        gForceDot1.setMaterial(white);
        rootNode.attachChild(gForceDot1);
        
        gForceDot2 = new Geometry("g-circle2", b);
        gForceDot2.setLocalTranslation(gcenter);
        gForceDot2.setMaterial(white);
        rootNode.attachChild(gForceDot2);
    ...
    public void update(float tpf) {
        ...
        gForceDot2.setLocalTranslation(gcenter.add(gs.mult(25))); // because screen pixels
