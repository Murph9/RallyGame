...
public class CarBuilder extends Node {
	...
	public void addPlayer(PhysicsSpace space, int id, FancyVT car, Vector3f start, Matrix3f rot, boolean AI) {
	...
	public void cleanup() {
		for (int key : carList.keySet()) {
			MyPhysicsVehicle car = carList.get(key);
			car.cleanup();
		}
	}
}
