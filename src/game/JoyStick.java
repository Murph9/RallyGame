...
public class JoyStick extends SimpleApplication {
    ...
    protected class GamepadView extends Node {
        ...
        public GamepadView() {
            ...
            addButton( JoystickButton.BUTTON_3, 371, 512 - 176, 42, 42 );
            addButton( JoystickButton.BUTTON_1, 407, 512 - 212, 42, 42 );
            addButton( JoystickButton.BUTTON_0, 371, 512 - 248, 42, 42 );
            addButton( JoystickButton.BUTTON_2, 334, 512 - 212, 42, 42 );
            ...
            addButton( JoystickButton.BUTTON_10, 67, 512 - 89, 95, 21 );
            addButton( JoystickButton.BUTTON_11, 348, 512 - 89, 95, 21 );
 
            // Select and start buttons           
            addButton( JoystickButton.BUTTON_6, 206, 512 - 198, 48, 30 );
            addButton( JoystickButton.BUTTON_7, 262, 512 - 198, 48, 30 );
            
            // Joystick push buttons
            addButton( JoystickButton.BUTTON_8, 147, 512 - 300, 75, 70 );
            addButton( JoystickButton.BUTTON_9, 285, 512 - 300, 75, 70 );
...
//            System.out.println( "Axis:" + axis.getName() + "=" + value );
            ...
            if( axis == axis.getJoystick().getXAxis() ) { //NORMAL STICK
                setXAxis(value);
            	...
            	setButtonValue("Button:12", value > 0.5);
                
            } else if( axis.getName().equals("Y Rotation") ) { //lol sketchy (but it is the other stick)
                setZRotation(-value);
            } else if( axis.getName().equals("X Rotation") ) { //also for second stick
                setZAxis(value);
                
            } else if( axis == axis.getJoystick().getPovXAxis() ) {
                if( lastPovX < 0 ) {
                    setButtonValue( "POV -X", false ); //this is the dpad
                } else if( lastPovX > 0 ) {
                ...
                if( lastPovY < 0 ) {
                    setButtonValue( "POV -Y", false ); //this is also the dpad
                } else if( lastPovY > 0 ) {
