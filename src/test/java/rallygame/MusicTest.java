...
public class MusicTest extends BaseAppState {
    ...
    protected void initialize(Application app) {
        ...
        backgroundMusic[0] = new AudioNode(app.getAssetManager(), "sounds/music/duel music-04_background.ogg", DataType.Buffer);
        backgroundMusic[0].setLooping(true);
        backgroundMusic[0].setPositional(false);
        rootNode.attachChild(backgroundMusic[0]);

        // add looping background sound
        backgroundMusic[1] = new AudioNode(app.getAssetManager(), "sounds/music/duel music-04_main.ogg", DataType.Buffer);
