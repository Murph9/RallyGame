...
public class DuelUiStyle {
    ...
    public static void load(AssetManager assetManager) {
        ...
        styles.setDefault(GuiGlobals.getInstance().loadFont("Interface/nasalization.fnt"));
        ...
        TbtQuadBackgroundComponent flat = TbtQuadBackgroundComponent.create("image/solid-white.png", 1, 1, 1,
                2, 2, 1f, false);
        flat.setColor(dialogBackground);

        TbtQuadBackgroundComponent double_gradient = TbtQuadBackgroundComponent
                .create("image/double-gradient-128.png", 1, 1, 1, 126, 126, 1f, false);
    ...
    public static GuiComponent getBorderedNoBackground() {
        TbtQuadBackgroundComponent d = TbtQuadBackgroundComponent.create("image/lemur_border.png", 1, 5, 5, 32-5, 32-5, 1f, false);
