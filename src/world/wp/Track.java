...
public enum Track implements WP {
	...
	STRAIGHT("straight.blend", new Vector3f(5,0,0), WP.STRAIGHT, NodeType.A, NodeType.A),
	BRIDGE("bridge.blend", new Vector3f(10,0,0), WP.STRAIGHT, NodeType.A, NodeType.A),
	CHICANE("chicane.blend", new Vector3f(12,0,0), WP.STRAIGHT, NodeType.A, NodeType.A),
	STRAIGHT_TUNNEL("straight_tunnel.blend", new Vector3f(3f,0,0), WP.STRAIGHT, NodeType.B, NodeType.B),
	...
	TUNNEL_IN("tunnel_in.blend", new Vector3f(3f,0,0), WP.STRAIGHT, NodeType.A, NodeType.B),
	TUNNEL_OUT("tunnel_out.blend", new Vector3f(3f,0,0), WP.STRAIGHT, NodeType.B, NodeType.A),
