...
public enum StaticWorld {
	...
	duct2("duct.blend", 5, new Vector3f(0,0,0), null),
	...
	unbenannt("unbenannt_track.blend", 1, new Vector3f(0,0,0), null), //TODO needs fixing
	
	block_fort("block_fort.blend", 10, new Vector3f(-20,0,-12), null),
	rainbow_road("rainbow_road.blend", 1, new Vector3f(0,0,0), null),
	wuhu_island("wuhu_island.blend", 2, new Vector3f(0,0,0), H.FromAngleAxis(FastMath.HALF_PI, Vector3f.UNIT_Y)),
	
	//debug ones:
	slope_test("slope_test.blend", 1, new Vector3f(), null)
