...
public enum StaticWorld {
	...
	garage("garage.blend", 1, new Vector3f(0,-3,0), false),
	
	skyline("skyline.blend", 800, new Vector3f(-27.7f, 84.5f, 111.3f), true), //large
	...
	mine("minecraft_world1.obj", 30, new Vector3f(0,10,0), false),
